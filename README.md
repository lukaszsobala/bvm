...
BVM was [released](https://github.com/Botspot/bvm/commit/038a5b452f3b9691cc64355c8272967c17ac2e9a) 3 days ago and it's ready for beta testers. Please [report](https://github.com/Botspot/bvm/issues) good and bad results. Do not assume I am already aware of an issue, unless you can find it in [Issues](https://github.com/Botspot/bvm/issues), in which case please comment with something like "I'm having this problem too."  
...
### Other notes:
- **Gratitude**: Thanks [Jeff Geerling](https://www.youtube.com/watch?v=mkfILjKJ8nc) and [Leepsp](https://www.youtube.com/watch?v=b7puJhWLQkU) for the YouTube videos!
...
- **USB passthrough** is not quite working yet, but it worked great in testing. The option is ready in the config file, but it will not do anything until I find an elegant way to change the ownership of USB devices to the current user. Running QEMU as root seems to break Wayland output in the `boot` mode, and can mess up other file permissions. This is being worked on.
...
### Ask me anything!
- Who made this?  
    I'm [Botspot](https://github.com/Botspot), a college student, bash scripter, Raspberry Pi user, and founder of [Pi-Apps](https://github.com/Botspot/pi-apps) and [WoR-Flasher](https://github.com/Botspot/wor-flasher). If you met me in real life you would just see another average kid. There is a chance I will be homeless in a matter of months through no fault of my own. [Looking for monetary support.](https://github.com/sponsors/Botspot)  
- Is this legal?  
