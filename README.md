...
- **USB passthrough:** Now available. [Adding this feature](https://github.com/Botspot/bvm/commit/9389caa5bcc7548363b0fad999f0e32591f16487) took a bit longer than I expected, but it's here now and works well. Edit the config file to set the new `usb_passthrough` variable. Everyone who set up BVM before this change needs to read the [latest version of bvm-config](https://github.com/Botspot/bvm/blob/main/resources/bvm-config) and copy those lines in, or click the new USB passthrough button in the gui.
